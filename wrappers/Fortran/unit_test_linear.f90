...
!             to create and manage 1D/2D/3D MUI interfaces and associated sampler objects
...
program main
  ...
  call mui_fetch_exact_linear_1d_f(uniface_1d, "position"//c_null_char, fetch_point_1, fetch_time, &
       spatial_sampler_exact_1d, temporal_sampler_linear_1d, fetch_result_1d)

  print *, "Fetched 1D interface value (linear temporal) = ",fetch_result_1d
  ...
  call mui_fetch_exact_linear_2d_f(uniface_2d, "position"//c_null_char, fetch_point_1, fetch_point_2, fetch_time, &
       spatial_sampler_exact_2d, temporal_sampler_linear_2d, fetch_result_2d)

  print *, "Fetched 2D interface value (linear temporal) = ",fetch_result_2d
  ...
  call mui_fetch_exact_linear_3d_f(uniface_3d, "position"//c_null_char, fetch_point_1, fetch_point_2, fetch_point_3, fetch_time, &
       spatial_sampler_exact_3d, temporal_sampler_linear_3d, fetch_result_3d)

  print *, "Fetched 3D interface value (linear temporal) = ",fetch_result_3d

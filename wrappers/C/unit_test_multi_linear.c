...
int main(int argc, char **argv) {
	...
	for(int i=0; i<num_interfaces; i++) {
		results1d[i] = mui_fetch_exact_linear_1d(unifaces1d[i], "position", fetch_point1d, 0, spatial_sampler1d,
				temporal_sampler1d);
	...
	// Fetch the value for tag "position" at fetch_point at time=0
	for(int i=0; i<num_interfaces; i++) {
		results2d[i] = mui_fetch_exact_linear_2d(unifaces2d[i], "position", fetch_point2d, 0, spatial_sampler2d,
				temporal_sampler2d);
	...
	// Fetch the value for tag "position" at fetch_point at time=0
	for(int i=0; i<num_interfaces; i++) {
		results3d[i] = mui_fetch_exact_linear_3d(unifaces3d[i], "position", fetch_point3d, 0, spatial_sampler3d,
				temporal_sampler3d);
